...
{{--                                <img class="uk-margin-small-right in-offset-top-10" style="margin-top: 3px" src="{{ asset('img2/logo.png') }}" data-src="{{ asset('img2/logo.png') }}" alt="{{ env('APP_NAME') }}" width="134" height="23" data-uk-img=""> --}}
                            </a>
